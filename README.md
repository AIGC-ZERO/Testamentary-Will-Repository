...
> 面向遗嘱登记、见证、保管、执行、监管与纠纷调解的一体化司法服务系统
> **Testamentary Will Repository** · Vue 3 + Vite

中国司法遗嘱数据库（系统）面向遗嘱数据库业务场景，提供完整的三端入口：
...
大屏定位为「中国司法遗嘱数据库（系统） · 智慧运营驾驶舱」，视觉上采用深蓝科技风 + 毛玻璃浮层，地图贯穿全屏：
...
- 业务规则与文案围绕「中国司法遗嘱数据库（系统）」场景设计，**不构成法律意见或正式业务系统**。
